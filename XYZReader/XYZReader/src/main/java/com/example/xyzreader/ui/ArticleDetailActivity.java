...
public class ArticleDetailActivity extends AppCompatActivity
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            mCursor.moveToPosition(position);
            Fragment fragment = ArticleDetailFragment.newInstance(mCursor.getString(ArticleLoader.Query.PUBLISHED_DATE),
                    mCursor.getString(TITLE),
                    mCursor.getString(AUTHOR),
                    mCursor.getString(BODY),
                    mCursor.getString(PHOTO_URL));
            return fragment;
        }
